...
| **③ 握手与 RTT 时延** | **20 分**<br>(抗时延探测) | • **$\le 50\text{ms}$**：`20 分`（极速建连，时延表现最自然）<br>• **$51 \sim 100\text{ms}$**：`17 分`<br>• **$101 \sim 200\text{ms}$**：`13 分`<br>• **$201 \sim 350\text{ms}$**：`8 分`<br>• **$351 \sim 600\text{ms}$**：`4 分`<br>• **$> 600\text{ms}$**：`1 分` |
